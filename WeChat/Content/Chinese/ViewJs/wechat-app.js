...
$(document).ready(function () {
    ...
    function ShowAlert(mess, numb) {
        if (mess == "User Session Expired.pls Relogin." || mess == "您目前的登录已过期或在其他地方登录相同账户") {
    ...
    function SearchDataUI(obj) {
        ...
        for (var i = 0; i < obj.length; i++) {
            ...
            if (obj[i]["exchange"] == undefined) {
                Html += strs + "<br counterId='" + obj[i]["counterID"] + "' watchlis-symbol='" + obj[i]["symbol"] + "' /><div><span>" + obj[i]["symbol"] + "</span></div></li>";
            } else {
                Html += strs + "<br  counterId='" + obj[i]["counterID"] + "' watchlis-symbol='" + obj[i]["symbol"] + "' /><div>" + obj[i]["exchange"] + ":<span>" + obj[i]["symbol"] + "</span></div></li>";
            }
            
        }
        Html += "</ul>";
        if (obj != undefined) {
            Html += "<p class='SHOWALL'>搜索 " + obj.length + " 数据</p>";
        } else {
            Html += "<p class='SHOWALL'>搜索 0 数据</p>";
        }
    ...
    function RemoveDataUI(obj, Editdetails) {
        ...
        if (obj.length != 0) {
            ...
            str += "<div class='No-datas' style='width: 100%;height: 35%;position: fixed;text-align: center;top:20%;'><p style='position: absolute;bottom: 10%;font-size: 28px;left: 33%;color: #ccc;'>没数据</p></div>";
            Editdetails.append(str);
    ...
    function OrderFormSTUI(obj, obj1, productIcon, counterId, name, product) {
        ...
        var str = "", str1 = "", str2 = ""; str3 = "<ul><li>可用现金</li><li>买入限额余额</li><li>卖出限制</li></ul>";
        var Datetime = data(1);
        var Domarry = [];
        ...
        $("#ST-Trade .Detail-content-top .CurrencyLotsize").append("<span style='display: block;width: 53%;float: left;'>货币：" + obj["currency"] + "</span><span>批量：" + obj["lotSize"] + "</span>");
    ...
    function OrderFormCFDUI(obj, creditLimit, productIcon, counterId, name, product, symbols) {
        ...
        var str10 = "<ul><li>可用现金</li><li>信贷限额</li></ul>";
        ...
        for (var i = 0; i < obj["orderTypes"].length; i++) {
            ...
            if (obj["orderTypes"][i]["orderType"] == "2") {
                ...
                $("#CFD-Limited-Order .CurrencyLotsize").append("<span style='display: block;width: 50%;float: left;'>货币: " + obj["currency"] + "</span><span>批量: " + obj["lotSize"] + "</span>");
                ...
                $("#CFD-Stop-Limited-Order .CurrencyLotsize").append("<span style='display: block;width: 50%;float: left;'>货币: " + obj["currency"] + "</span><span>批量: " + obj["lotSize"] + "</span>");
                ...
                $("#CFD-Trailling-Stop-Order .limitSpread span:first-child").text("限制止损价格: " + obj["lastDone"]);
                ...
                $("#CFD-Trailling-Stop-Order .limitSpread span:last-child").text("批量: " + obj["lotSize"]);
                ...
                $.post(rootpath + "Trade/CfdLimitOrder", "counterId=" + counterId, function (d) {
                    ...
                    if (o["code"] == 1) {
                        if (orders.length > 0) {
                            str11 += "<option value=''>选取订单号</option>";
                            ...
                            SelectOrderNo.append("<option value=''>选取订单号</option>");
                        }
                    }
                    else {
                        SelectOrderNo.append("<option value=''>选取订单号</option>");
                ...
                $("#CFD-OCO-Order .CurrencyLotsize").eq(0).append("<span style='display: block;width: 50%;float: left;'>货币: " + obj["currency"] + "</span><span>批量: " + obj["lotSize"] + "</span>");
                ...
                $("#CFD-OCO-Order .CurrencyLotsize").eq(1).append("<span style='display: block;width: 50%;float: left;'>货币: " + obj["currency"] + "</span><span>批量: " + obj["lotSize"] + "</span>");
                ...
                $("#CFD-Contingency-Order .CurrencyLotsize").append("<span style='display: block;width: 50%;float: left;'>货币: " + obj["currency"] + "</span><span>批量: " + obj["lotSize"] + "</span>");
    ...
    function CFDTraillingkey(string) {
        ...
        $("#CFD-Trailling-Stop-Order .limitSpread span:first-child").text("限制止损价格: " + price);
        ...
        $("#CFD-Trailling-Stop-Order .input-input input:first-child").keyup(function () {
            ...
            if ($(this).val() == "") {
                limitSpread.text("限制止损价格: " + price1);
            } else {
    ...
    function OrderFormFTFXFXMNUI(obj, productIcon, counterId, name, product, exchange, symbol) {
        //变量
        var str = "", str1 = "", str2 = "<ul><li>余额</li><li>保证金盈余/亏损</li><li>使用</li></ul>";
        var arry = [];
        ...
        $("#FTFXFXMN-Limited-Order .input-input").next().text("");
        $("#FTFXFXMN-Limited-Order .input-input").next().next().text("");
        ...
        $("#FTFXFXMN-Limited-Order .input-input").next().text("货币:" + obj["data"]["marginCurrency"]);
        ...
        $.get(rootpath + "PortfolioFtFx/Account?product=FT", function (d) {
            var o = JSON.parse(d);
            if (o["code"] == 1) {
                str2 += "<ul><li>" + o["data"]["marginExcessDeficit"] + " " + o["data"]["baseCurrency"] + "</li><li>" + o["data"]["marginExcessDeficit"] + " " + o["data"]["baseCurrency"] + "</li><li>" + o["data"]["utilization"]+"</li></ul>";
                FTFXFXMNAmount.append(str2);
                $("#FTFXFXMN-Trade").show();
            }
            else {
                str2 += "<ul><li>-</li><li>-</li><li>-</li></ul>";
                FTFXFXMNAmount.append(str2);
                $("#FTFXFXMN-Trade").show();
            }
        });
    ...
    function FormInfoUT_GeneralInfo(object, name) {
        ...
        let Strings = "<ul><li></li>", Strings1 = "<ul><li>现金</li><li>SRS-IA</li><li>CPEOA-IA</li><li>CPESA-IA</li></ul>", a = 0, arry = [];
        ...
        Strings = "<ul><li></li>";
        Strings1 = "<ul><li>现金</li><li>SRS-IA</li><li>CPEOA-IA</li><li>CPESA-IA</li></ul>";
        //Relevant Charges
        ...
        //Fund Awards
        var hpx = FontSizeUT("Lipper等级分类");
        Strings = "<ul><li style='" + hpx + "'>Lipper等级分类</li>";
        Strings1 = "<ul><li>总回报</li><li>一致回报</li><li>保存</li><li>费用</li></ul>";
        ...
        var hpx = FontSizeUT("Morningstar等级分类");
        Strings = "<ul><li style='" + hpx + "'>Morningstar等级分类</li>";
        Strings1 = "<ul><li>总体</li><li>三年</li><li>五年</li><li>十年</li></ul>";
    ...
    function FormInfoUT_Rsp(object) {
        ...
        if (object["approved"]) {
            ...
            //
            Regular_Savings_Plan_p.append("<span>更多关于定期储蓄计划费用</span>");
        ...
        else
        {
            ...
            //
            Regular_Savings_Plan_p.append("该基金不可用于正常储蓄计划<br/><span>点击这里</span>查看RSP批准的基金名单");
    ...
    function OrderFormUT(object, productIcon, counterId, name, product, availableCash, Documents) {
        ...
        Buy_MIA.append("<span>最少投资金额:</span><span>" + object["buyInfo"]["minIniInvAmt"] + " " + object["buyInfo"]["fundCurrency"] + "</span>");
        Buy_MAA.append("<span>最少子投资金额:</span><span>" + object["buyInfo"]["minSubInvAmt"] + " " + object["buyInfo"]["fundCurrency"] + "</span>");
        Buy_SE.append("<span>销售费用:</span><span>" + Number(object["buyInfo"]["salesCharge"]) + "%</span>");
        ...
        if (Switch_The_ReferenceS.length > 0) {
            ...
            Switch_Search_fund.removeAttr("class").append("<div><input type='text' name='Amount' value='' placeholder='点击查找基金名称' autocomplete='off' /></div>");
                ...
                if (orderType.val() == "2") {
                    if (action == 1) {
                        if (price > LatestAskPrice || LatestAskPrice.toString() == "NaN") {
                            //ShowAlert("您试图按当前市价提交订单，如果您继续进行。您可以按您提交的价格完成，您要继续吗？");
                            $("#loading").hide();
                            //return;
                            attemptedMessage = "您试图按当前市价提交订单，如果您继续进行。您可以按您提交的价格完成，您要继续吗？";
                        }
    ...
    //$.ajax({
    //    type: "POST",
    //    url: rootpath + "Watchlist/getWatchlistDetail?",
    //    data: "watchlistId=828",
    //    dataType: "json",
    ...
    function DetailFormUI(String, product, market, Ele, Eles, spTickSize) {
        ...
        if (product == "FX" || product == "FXMN") {
            ...
            if (arrys3[0] == undefined) {
                htmls += "<ul style='width: 100%;position: relative;'><li style='font-size: 10px;width: 12%;'>买价</li><li style='font-size: 10px;width: 25%;' flag='flag' class='" + symbol + "_5 Spreads'>-</li> <li style='position: absolute;left: 42%;width: 16%;text-align: center;color: #f2f2f2;font-size: 10px;' id='Difference'>-</li> <li flag='flag' class='" + symbol + "_6 Spreads' style='float: right;font-size: 10px;width: 25%;padding-right: 0.45rem;'>-</li><li style='float: right;font-size: 10px;width: 10%;'>卖价</li></ul>";
                htmls += "<ul style='width: 100%;position: relative;clear: both;'><li style='font-size: 10px;width: 12%;text-align: left;'>最低价</li><li style='font-size: 10px;width: 25%;' flag='flag' class='" + symbol + "_8'>-</li> <li style='position: absolute;left: 42%;width: 16%;text-align: center;font-size: 10px;'>差价</li> <li flag='flag' class='" + symbol + "_7' style='float: right;font-size: 10px;width: 25%;padding-right: 0.45rem;'>-</li><li style='float: right;font-size: 10px;width: 11%;text-align: left;'>最高价</li></ul>";
            } else {
                ...
                htmls += "<ul style='width: 100%;position: relative;'><li style='font-size: 10px;width: 12%;'>买价</li><li style='font-size: 10px;width: 25%;' flag='flag' class='" + symbol + "_5 Spreads'>" + arrys3[0] + "</li> <li style='position: absolute;left: 42%;width: 16%;text-align: center;color: #f2f2f2;font-size: 10px;' id='Difference'>" + Spreadval + "</li> <li flag='flag' class='" + symbol + "_6 Spreads' style='float: right;font-size: 10px;width: 25%;padding-right: 0.45rem;'>" + arrys3[1] + "</li><li style='float: right;font-size: 10px;width: 10%;'>卖价</li></ul>";
                htmls += "<ul style='width: 100%;position: relative;clear: both;'><li style='font-size: 10px;width: 12%;text-align: left;'>最低价</li><li style='font-size: 10px;width: 25%;' flag='flag' class='" + symbol + "_8'>" + arrys3[3] + "</li> <li style='position: absolute;left: 42%;width: 16%;text-align: center;font-size: 10px;'>差价</li> <li flag='flag' class='" + symbol + "_7' style='float: right;font-size: 10px;width: 25%;padding-right: 0.45rem;'>" + arrys3[2] + "</li><li style='float: right;font-size: 10px;width: 11%;text-align: left;'>最高价</li></ul>";
            }
            Eles.append(htmls);
            ...
            if (arrys1[0] == undefined) {
                ...
                htmls += "<ul><li>买价</li><li flag='flag' class='" + symbol + "_5'>-</li><li>卖价</li><li flag='flag' class='" + symbol + "_6'>-</li></ul>";
                if (product == "FT") {
                    htmls += "<ul><li style='text-align: left;'>最低价</li><li flag='flag' class='" + symbol + "_15'>-</li><li style='text-align: left;'>最高价</li><li flag='flag' class='" + symbol + "_16'>-</li></ul>";
                }
                else {
                    htmls += "<ul><li style='text-align: left;'>买量(千)</li><li flag='flag' class='" + symbol + "_15'>-</li><li style='text-align: left;'>卖量(千)</li><li flag='flag' class='" + symbol + "_16'>-</li></ul>";
                }
                ...
                htmls += "<ul><li>买价</li><li flag='flag' class='" + symbol + "_5'>" + arrys1[0] + "</li><li>卖价</li><li flag='flag' class='" + symbol + "_6'>" + arrys1[1] + "</li></ul>";
                if (product == "FT") {
                    htmls += "<ul><li style='text-align: left;'>最低价</li><li flag='flag' class='" + symbol + "_15'>" + arrys1[4] + "</li><li style='text-align: left;'>最高价</li><li flag='flag' class='" + symbol + "_16'>" + arrys1[5] + "</li></ul>";
                }
                else {
                    htmls += "<ul><li style='text-align: left;'>买量(千)</li><li flag='flag' class='" + symbol + "_15'>" + arrys1[4] + "</li><li style='text-align: left;'>卖量(千)</li><li flag='flag' class='" + symbol + "_16'>" + arrys1[5] + "</li></ul>";
                }
    ...
    function DetailFormUIs(Ele, Eles, flg) {
        ...
        var html = "", htmls = "";
        if (flg == undefined) {
            html += "<h3 flag='flag' >-</h3><ul><li flag='flag' >-</li><li flag='flag'>-</li><li></li></ul>";

            htmls += "<ul><li>买价</li><li flag='flag' >-</li><li>卖价</li><li flag='flag' >-</li></ul>";
            htmls += "<ul><li style='text-align: left;'>买量(千)</li><li flag='flag' >-</li><li style='text-align: left;'>卖量(千)</li><li flag='flag' >-</li></ul>";
        ...
        Ele.hide();
        htmls += "<ul style='width: 100%;position: relative;'><li style='font-size: 10px;width: 10%;'>买价</li><li style='font-size: 10px;width: 25%;'>-</li> <li style='position: absolute;left: 42%;width: 16%;text-align: center;color: #f2f2f2;font-size: 10px;' id='Difference'>-</li> <li style='float: right;font-size: 10px;width: 25%;padding-right: 0.45rem;'>-</li><li style='float: right;font-size: 10px;width: 10%;'>买价</li></ul>";
        htmls += "<ul style='width: 100%;position: relative;clear: both;'><li style='font-size: 10px;width: 10%;'>最高价</li><li style='font-size: 10px;width: 25%;'>-</li> <li style='position: absolute;left: 42%;width: 16%;text-align: center;font-size: 10px;'>差价</li> <li style='float: right;font-size: 10px;width: 25%;padding-right: 0.45rem;'>-</li><li style='float: right;font-size: 10px;width: 10%;'>最低价</li></ul>";
        Eles.append(htmls);
    ...
    function FormUTDataUI2(Ele, Eles, obj) {
        ...
        htmls += "<ul><li flag='flag' style='font-size: 14px;color: #c1c1c1;width: 98%;text-align: right;'>指示性净资产为</li><li style='width: 98%;font-size: 20px;font-weight: bolder;text-align:right'>" + obj[0]["dealingDate"] + "</li></ul>";
        Ele.append(html);
    ...
    function OrderStatusContent(obj, arry) {
        ...
        Html += "<tr><td>数量&nbsp;&nbsp;&nbsp;" + arry[6] + "</td><td>" + arry[8] + "</td></tr>";
    ...
    function DetailUIObj(o, obj, product, orderType) {
        ...
        newobj["订单号"] = o["orderNo"];
        newobj["StatusColor"] = o["statusColor"];
        newobj["订单类型"] = orderType;
        newobj["买/卖"] = o["action"];

        if (o["statusDesc"] == undefined) {
            newobj["状态"] = o["statusDescription"];
        } else {
            newobj["状态"] = o["statusDesc"];
        }
        ...
        if (o["submittedQty"] == undefined) {
            ...
            newobj["数量"] = o["submittedQty"];
            //submittedQty = o["submittedQty"];
        }

        newobj["货币"] = o["currency"];
        if (o["paymentMode"] == undefined) {
            newobj["交易类型"] = o["tradeType"];
        } else {
            newobj["交易类型"] = o["paymentMode"];
        }

        if (o["settlementCurrency"] == undefined) {
            newobj["结算货币"] = o["paymentCurrency"];
        } else {
            newobj["结算货币"] = o["settlementCurrency"];
        }
        if (o["validity"] == undefined) {
            newobj["期限"] = o["expiry"];
        } else {
            newobj["期限"] = o["validity"];
        }
        if (product != "ST") {
            if (o["submittedTime"] == undefined) {
                newobj["提交时间"] = obj[0]["time"];
            } else {
                newobj["提交时间"] = o["submittedTime"];
            }
            newobj["提示信息"] = o["message"];
        }
        return newobj;
    }
    ...
    function productCFD(o, obj, product, newobj) {
        ...
        if (o["orderType"] == "Stop Limit") {
            newobj["止损价格"] = o["stopPrice"];
            newobj["止损价格触发"] = o["stopPriceTrigger"];
            newobj["Corr订单号"] = o["correspondLimitOrderNo"];
        }
            ...
            newobj["一旦完成限价订单号"] = o["correspondOrderNo"];
            newobj["Corr订单号"] = o["correspondLimitOrderNo"];
        }
        else if (o["orderType"] == "OCO Stop") {
            newobj["OCO 止损限制-止损价格"] = o["stopPrice"];
            newobj["OCO 止损限制-触及限价"] = o["stopPriceTrigger"];
            newobj["OCO 止损限制-限价"] = o["submittedPrice"];
            newobj["OCO 止损限制-数量"] = o["qty"];
            ...
            newobj["相应条件"] = o["contingencyCondition"];
            newobj["Corr订单号"] = o["correspondLimitOrderNo"];
        }
        if (o["orderType"] != "Trailing Stop") {
            newobj["设置货币"] = o["settlementCurrency"];
    ...
    function productFTFXFXMN(o, obj, product, newobj) {
        ...
        if (newobj["数量"] == undefined) {
            newobj["数量"] = o["stopLimitPrice"];
        }
        ...
        if (o["submittedTime"] == undefined) {
            newobj["提交时间(S)"] = obj[0]["time"];
        } else {
            newobj["提交时间(S)"] = o["submittedTime"];
        }
        newobj["提示信息"] = o["message"];
        return newobj;
    }
    ...
    function productUT(o, obj, product, newobj) {
        ...
        newobj["状态"] = o["statusDesc"];
        newobj["买/卖"] = o["action"];
        newobj["基金来源"] = o["fundSource"];
        newobj["货币"] = o["currency"];
        newobj["单位"] = o["units"];
        newobj["投资金额"] = o["amount"] + " " + o["currency"];
        newobj["指示性资产净值"] = o["nav"];
        newobj["指示性交易日期"] = o["indicativeTransactionDate"];
        newobj["POEMS销售费用"] = o["salesCharge"];
        return newobj;
    }
    ...
    function OrderStatusDetailUI(o, obj, counterId, product, symbol, exchange, orderType) {
        ...
        var submittedQty = newobj["数量"];
        var submittedPrice = newobj["价格"];
    ...
    function Detailcontenttop(orderType, newobj, product) {
        $("#OrderStatus-Detail-content div").eq(0).empty();
        ...
        $("#OrderStatus-Detail-content div").eq(0).append(Html);
        $("#OrderStatus-Detail-content div").eq(0).height(contentHeight + 2.4 + "rem");
        
        if (product == "UT")
            TimeMsgEle($("#OrderStatus-Detail-content .Detail-content-top"), product);
        else
            TimeMsgEle($("#OrderStatus-Detail-content .Detail-content-top"));
    }
        ...
        for (var key in newobj) {
            if (newobj[key] != "") {
                if (orderType == "If Done") {
                    ...
                    if (key == "OCO 止损限制-止损价格" || key == "OCO 止损限制-触及限价" || key == "OCO 止损限制-数量" || key == "OCO 止损限制-限价")
                        Html += "<ul><li style='width:23%'>" + newobj[key] + "</li><li style='width:76%'>" + key + "</li></ul>";
                    else
                        if (str == undefined)
                            str = DetailcontenttopSize(Html, key, newobj);
                    ...
                    if (key == "OCO 止损限制-限价" || key == "OCO 止损限制-数量")
                        Html += "<ul><li style='width:23%'>" + newobj[key] + "</li><li style='width:76%'>" + key + "</li></ul>";
                    else
                        if (str == undefined)
                            str = DetailcontenttopSize(Html, key, newobj);
    ...
    function WithdrawAmend(orderNo, submittedQty, submittedPrice, counterId, product, symbol, exchange, ocoPrice,obj) {
        ...
        if (withdrawURI != "") {
            ...
            $("#Withdraw").click(function () {
                ...
                var Html = "";
                if (passwordConfirmation == false) {
                    Html += "<p>撤销订单</p><p>你确认要撤销此订单吗?</p>";
                    Html += "<p>" + obj["action"] + " " + submittedQty + " of " + name + " (" + exchange + ":" + symbol + ") at " + submittedPrice + "</p>";
                    Html += "<div><a id='Withdraw-Nofalse'>取消</a><a id='Withdraw-Yestrue'>提交</a></div>";
                } else {
                    Html += "<p>撤销订单</p><p>你确定要取消订单吗?</p>";
                    Html += "<p>" + obj["action"] + " " + submittedQty + " of " + name + " (" + exchange + ":" + symbol + ") at " + submittedPrice + "</p>";
                    Html += "<p>确认密码</p>";
        ...
        if (amendURI != "") {
            ...
            $("#Amend").click(function () {
                ...
                if (passwordConfirmation == false) {
                    if (product == "FT" || product == "FX" || product == "FXMN") {
                        Html += "<p>修改订单</p><p>" + obj["action"] + " " + submittedQty + " " + name + " (" + exchange + ":" + symbol + ")</p>";
                        if (ocoPrice == "") {
                            Html += "<p><span>价格</span><span></span></p>";
                            if (submittedPrice == undefined) {
                            ...
                            Html += "<p><span>Price</span><span>OCO价格</span></p>";
                        ...
                        Html += "<p>修改订单</p><p>" + obj["action"] + " " + submittedQty + " " + name + " (" + exchange + ":" + symbol + ")</p>";
                        Html += "<p><span>价格</span><span>数量</span></p>";
                    ...
                    Html += "<div><a id='Amend-Nofalse'>取消</a><a id='Amend-Yestrue'>提交</a></div>";
                } else {
                    if (product == "FT" || product == "FX" || product == "FXMN") {
                        Html += "<p>修改订单</p><p>" + obj["action"] + " " + submittedQty + " " + name + " (" + exchange + ":" + symbol + ")</p>";
                        if (ocoPrice == "") {
                    ...
                    Html += "<p><span>确认密码</span><span></span></p>";
    ...
    function PortfolioUIdata(clientName, accountType, total, balanceInfo, disclaimers) {
        ...
        for (var i = 0; i < balanceInfo.length; i++) {
            ...
            for (var type in Arrys){
                if (balanceInfo[i]["type"] == Arrys[type]) {
                    str += "<div><p><span >" + type + "</span><span>" + balanceInfo[i]["currency"] + " " + balanceInfo[i]["balance"] + "</span></p><p>截止 " + balanceInfo[i]["lastUpdated"] + "</p></div></li></ul>";
                }
            }
        ...
        Portfoliobottomp.html("<span>合计</span><span>" + total + "</span>");
        $("#Portfolio-top-title").append("投资组合(" + accountNo + ") " + "<span>" + clientName + "</span>");
        $("#show-Disclaimer .Disclaimer-content").text(disclaimers);
        canvaS(balanceInfo);
        PortfoliDetailData($(".product-Details"), Arrys);
        PortfoliDetailData($("#Portfolio-drop-down ul li:not(:first-child)"), Arrys);
    ...
    function PortfoliDetailData(ele, Arrys) {
        ...
        ele.click(function () {
            ...
            if (type == "ST") {
                $.post(rootpath + "Portfolio/STKAccountDetails", "accountType=" + accountType, function (d) {
                    ...
                    if (accountDetails["code"] == 1) {
                        ...
                        PortfoliDetailAccountNoDetailUIST(PortfoliDetaititle, type, typeIcon, accountDetailsarry, accountDetails["lastUpdated"], Arrys);
                ...
                $.get(rootpath + "Portfolio/CFDAccountDetails", function (d) {
                    ...
                    if (Account["code"] == 1) {
                            PortfoliDetailAccountNoDetailUIST(PortfoliDetaititle, type, typeIcon, Account, Account["lastUpdated"], Arrys);
                ...
                $.get(rootpath + "PortfolioFtFx/Account?product=" + type, function (d) {
                    var Account = JSON.parse(d);
                    if (Account["code"] == 1) {
                                PortfoliDetailAccountNoDetailUIST(PortfoliDetaititle, type, typeIcon, Account["data"], Account["data"]["lastUpdatedTime"], Arrys);
    ...
    function PortfoliDetailAccountNoDetailUIST(PortfoliDetaititle, type, typeIcon, obj, String, Arrys) {
        //存在的后续问题if有前提条件的话
        var str = "";
        var strs = "<ul><li>描述</li>";
        var objs = obj.length;
        ...
        if (type != "期货/外汇") {
            ...
            var strs = "<ul><li style='width:50%'>描述</li>";
    ...
    function STAccountNoDetailData(strs,obj) {
        var newobj = {}, arry = [];
        strs = "<ul><li style='width:50%'>描述</li>";
        for (var i in obj) {
            if (i == "currency") {
                ...
                if (i == "balanceAsYesterday")
                    newobj["截止昨天的余额"] = obj[i];
                else if (i == "fundReceivedToday")
                    newobj["今日到账金额(b)"] = obj[i];
                else if (i == "openingBalanceToday")
                    newobj["今日期初余额(a+b)"] = obj[i];
                else if (i == "itemsDueForSettlement")
                    newobj["到期结算的项目c"] = obj[i];
                else if (i == "availableBalance")
                    newobj["可用余额(a+b)+c"] = obj[i];
                else if (i == "allItemsOutstanding")
                    newobj["所有未结算头寸(d)"] = obj[i];
                else if (i == "netAmount")
                    newobj["净额(a+b)+(d)"] = obj[i];
                else if (i == "totalAssetValue")
                    newobj["总资产值(开放)"] = obj[i];
    ...
    function FTFXAccountNoDetailData(obj) {
        ...
        //if (obj.baseCurrency == "SGD") {
            ...
            Html += "<ul><li style= 'width:49.4%'><span>分类账余额</span></li><li style='width:49.4%;'>" + newobj["ledgerBalance"] + "</li></ul >";
            Html += "<ul><li style= 'width:49.4%' ><span>账户余额</span></li><li style='width:49.4%;'>" + newobj["accountBalance"] + "</li></ul >";
            color = setColor(newobj["unrealizedPL"]);
            Html += "<ul><li style= 'width:49.4%' ><span>潜在损盈</span></li><li style='width:49.4%;color:" + color + "'>" + newobj["unrealizedPL"] + "</li></ul >";
            color = setColor3(newobj["marginExcessDeficit"]);
            Html += "<ul><li style= 'width:49.4%' ><span>保证金余额/赤字</span></li><li style='width:49.4%;color:" + color + "'>" + newobj["marginExcessDeficit"] + "</li></ul >";
            Html += "<ul><li style= 'width:49.4%' ><span>投资组合初始保证金</span></li><li style='width:49.4%;'>" + newobj["initialMargin"] + "</li></ul >";
            Html += "<ul><li style= 'width:49.4%' ><span>维持保证金</span></li><li style='width:49.4%;'>" + newobj["maintenanceMargin"] + "</li></ul >";
            color = setColor2(newobj["utilization"]);
            Html += "<ul><li style= 'width:49.4%' ><span>利润率</span></li><li style='width:49.4%;color:" + color + "'>" + newobj["utilization"] + "</li></ul >";
    ...
    function PortfoliDetailElementSize(typeIcon, Color, type, number, PortfoliDetaititle, String) {
        ...
        $("#AccountNo-Detail-bottom").append("<p>最后更新: " + String + "</p>");

        for (var i = 0; i < $("#Portfolio-drop-down li:not(:first-child)").length; i++) {
            if ($($("#Portfolio-drop-down li:not(:first-child)")[i]).text() == typeIcon) {
                $($("#Portfolio-drop-down li:not(:first-child)")[i]).css("color", "#D47510");
            }
        }
    ...
    function PortfoliDetailPositionsUIST(typeIcon, obj, obj1) {
        ...
        $("#PositionS-bottom").append("<p><span>合计(" + obj["currency"] + ")</span><span>" + obj["total"] + "</span></p><p>最后更新:" + obj["lastUpdated"] + "</p>")
    ...
    PortfoliDetailPositionsUIUT = (typeIcon, object, holdings) => {
        ...
        for (let f = 0; f < holdings.length; f++)
        {
            ...
            string += "<li style='height: 26px;line-height: 26px;text-indent: 1rem;background: #979797;font-size: 13px;border: none;'> 分类总和：(" + holdings[f]["currency"] + ")</li>";
        ...
        string += "<li style='height: 26px;line-height: 26px;text-indent: 1rem;background: #979797;font-size: 13px;border: none;'> 总和(" + object["currency"] + " Base)</li>";
        ...
        $("#PositionS-bottom").append("<p>最后更新: " + object["lastUpdated"] + "</p>")
    ...
    $("#Position").click(function () {
        ...
        $("#Position-top-title").append("未结算仓位<span>" + accountNo + "-EQ/UT</span>");
    ...
    function PositionSubsidiaryDataUI(obj,flg) {
        ...
        str += "<p>分类总和(SGD):<span style='color:" + obj["groupSummaryColor"] + "'>" + obj["groupSummary"] + "</span></p>";
        PositionSelecbottom.append(str);
        PositionSelecttop.append("到期 ：" + obj["groupHeader"] + "<span></span>");
    ...
    function PositionCoreDataUI(obj) {
        ...
        PositionBottom.append("<p><span>最后更新 : " + obj["lastUpdated"] + "</span><span id='Position-Disclaimer'>免责声明</span></p>");
    ...
    function PositionsDetailData(productIcon, name, obj) {
        ...
        if (productIcon == "EQ") {
            if (obj["contractNo"] != null || obj["contraNo"] != null) {//data cannot empty!
                if (contracts != undefined && contracts != null) {
                    ...
                    newobj["合约编号"] = obj["contractNo"];
                    newobj["合约日期"] = obj["contractDate"];
                    newobj["到期日"] = obj["dueDate"];
                    newobj["价格"] = obj["price"];
                    newobj["数量"] = obj["quantity"];
                    newobj["Settlement AmountColor"] = obj["settlementAmountColor"];
                    newobj["结算金额"] = obj["settlementAmount"] + " " + obj["currency"];
                    newobj["支付模式"] = obj["paymentMode"];
                    newobj["汇率"] = obj["exchangeRate"];
        ...
        else
        {
            ...
            {
                newobj["交易号"] = obj["transactionNo"];
                newobj["交易日期"] = obj["transactionDate"];
                newobj["投资类型"] = obj["investmentType"];
                newobj["交易类型"] = obj["transactionType"];
                newobj["订单来源"] = obj["orderSource"];
                newobj["订单状态"] = obj["orderStatus"];
                newobj["基金来源"] = obj["fundSource"];
                newobj["货币"] = obj["currency"];
                newobj["还剩天数"] = obj["noOfDays"];
                newobj["总额"] = obj["amount"];
                newobj["结算日期"] = obj["settlementDate"];
                newobj["银行自动转帐"] = obj["giro"];
            }
    ...
    function PositionsClassTwoTOP(obj) {
        ...
        var strs = "", newobj = {};
        newobj["paymentDueColor"] = obj["paymentDueColor"];
        if (obj["contraNo"] != null && obj["contraNo"] != "")
            newobj["合约编号"] = obj["contraNo"];
        else
            newobj["合约编号"] = "-";
        if (obj["date"] != null && obj["date"] != "")
            newobj["合约日期"] = obj["date"];
        else
            newobj["合约日期"] = "-";
        if (obj["dueDate"] != null && obj["dueDate"] != "")
            ...
            newobj["到期日"] = "-";
        if (obj["exchangeRate"] != null && obj["exchangeRate"] != "")
            newobj["汇率"] = obj["exchangeRate"];
        else
            newobj["汇率"] = "-";
        if (obj["paymentMode"] != null && obj["paymentMode"] != "")
            ...
            newobj["支付模式"] = "-";
        if (obj["paymentDue"] != null && obj["paymentDue"] != "")
            newobj["结算金额"] = obj["paymentDue"] + " " + obj["currency"];
        else
            newobj["结算金额"] = "-";
        ...
        for (var i in newobj) {
            if (i == "paymentDueColor") {
                ...
                if (i == "结算金额") {
                    strs += "<ul><li style='color:" + clolr + "'>" + newobj[i] + "</li><li>" + i + "</li></ul>";
                }
                else {
        ...
        if (obj["contracts"].length == 0 && obj["contracts"] == null) {
            ...
            for (var i = 0; i < obj.length;i++) {
                strs += "<ul class='OutstandingPositions-content-down-top'>";
                    strs +="<li>" + obj[i]["contractNo"] + "(" + obj[i]["action"] + ")</li><li>合约编号</li>";
                strs += "<span></span></ul>";
                strs += "<div class='OutstandingPositions-content-down-bottom' style='display:none'>";
                    strs += "<ul><li>" + obj[i]["contractDate"] + "</li><li>合约日期</li></ul>";
                    strs += "<ul><li>" + obj[i]["particulars"] + "</li><li>个人细节</li></ul>";
                    strs += "<ul><li style='color:" + obj[i]["amountColor"] + "'>" + obj[i]["amount"] + "</li><li>结算金额</li></ul>";
                strs += "</div>";
    ...
    function TradeSearchDataUI(obj) {
        ...
        for (var i = 0; i < obj.length; i++) {
            str = WatchlistOrderStatusLeft(obj, obj[i]["productIcon"], obj[i]["name"], s, 1);
            if (obj[i]["exchange"] == undefined) {
                Html += str + "<br name='" + obj[i]["name"] + "' counterId='" + obj[i]["counterID"] + "' symbol='" + obj[i]["symbol"] + "' product='" + obj[i]["product"] + "' exchange='" + obj[i]["exchange"] + "' producticon='" + obj[i]["productIcon"] + "'/><div><span>" + obj[i]["symbol"] + "</span></div></li>";
            } else {
                Html += str + "<br name='" + obj[i]["name"] + "' counterId='" + obj[i]["counterID"] + "' symbol='" + obj[i]["symbol"] + "' product='" + obj[i]["product"] + "' exchange='" + obj[i]["exchange"] + "' producticon='" + obj[i]["productIcon"] + "'/><div>" + obj[i]["exchange"] + ":<span>" + obj[i]["symbol"] + "</span></div></li>";
            }
            m++;
        }
        hl = hieg * m + hieg; m = 0;
